...
5\. You will now be on the APIC log in page. Select the **TechCon LDAP** User Registry. This will log you into the Provider Org you will be using.  
...
9\. Once you are logged in, you can explorer varies sections in the Developer Portal.   For now, let's go the Account Product we created and Published to. 
...
11\. Here we select the GET user operation and the try it. You will see that to test this API we need to register an application. Click on that link now. 
