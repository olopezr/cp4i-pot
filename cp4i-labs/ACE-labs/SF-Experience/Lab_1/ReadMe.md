...
4\. Now you will see the GET Url for our API and the Security Credentials.  Since we are not passing anything into the API we can just go ahead and Click on **Send**
